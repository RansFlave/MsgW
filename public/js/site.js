...
var title = "MsgWind"; // Site Başlığı
var sunucu = "http://localhost:3000"; // Sunucu adresi
var socket = null;
var tarih = new Date()
var sdas = require("../css")
...
function SocketEvents(){
    ...
    socket.on('MsjGoster', function (data) { // Herhangi bir kişi mesaj gönderirse..       
        ...
        $("#cikti").prepend("<b style='color:"+data.kisi.renk+"'>"+data.kisi.nick +" - "+  tarih.toLocaleDateString("tr-TR") +"</b> : <br>"+ data.msj +"<hr>");   
        $(".progress").hide();
